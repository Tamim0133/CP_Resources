...
3 4
 ...
 Paused / Done এই কনসেপ্ট এর উপর বেজ করে এই এলগোরিদম চলে ।

 যদি আমরা ভালো করে DFS টাকে দেখি

 void dfs(int node)
{
    visited[node] = 1;--------------------> পজড স্টেট

    for (auto i : adj_list[node])        }
    {					 }
        if (visited[i] == 0)             }	এক্সপ্লোরেশন
        { 				                 }    স্টেজ
            dfs(i);                      }
        }                                }
    }                                    }
...
ফর লুপ শেষ হেল অই নোডের জন্য ডান স্টেজ শেষ হয় ।

যদি "এক্সপ্লোর করার সময় আমরা কোন পজড নোড পাই" তারমানে অই খানে একটা সাইকেল এক্সিশট করে
*/
